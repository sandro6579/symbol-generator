...
output = imread(strcat('H:\Project\SG_Project\test_files\test_random_1\output\out_img_',num2str(img_num),'.bmp'));
output = double(output(:,:,1));
expected = imread(strcat('H:\Project\SG_Project\test_files\test_random_1\expected\out_img_',num2str(img_num),'.bmp'));
