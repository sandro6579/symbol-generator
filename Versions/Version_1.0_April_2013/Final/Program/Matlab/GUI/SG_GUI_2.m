...
handles.pic_name='H:\Project\Project Files\Matlab\GUI\GUI - final\symbols\symbol_0.bmp'; % the symbol path name. For example: handles.pic_name = "H:\Project\Project Files\Matlab\GUI\Project Files_yoav\Matlab\MATLAB\GUI - final\symbol_00.bmp"  
...
% %         file_UART = fopen(strcat(folder_name,'\uart_tx\uart_tx_',num2str(handles.uart_txt_num),'.txt'),'w'); 28.03.2013 olga
        ...
        % Prepare serial port
		serial_port= instrfind('Port','COM3'); %Close any COM3 serial connection
