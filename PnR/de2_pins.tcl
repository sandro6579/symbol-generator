...
#   set_location_assignment PIN_V2   -to SW17  ;# SW17 on the left side
   ...
   set_location_assignment PIN_AE22  -to programming_indication_led ;# LEDG0 on the right side
...
#   set_location_assignment PIN_AE15  -to LEDR13  ;# LEDR13
   set_location_assignment PIN_AF13  -to dbg_actual_wr_bank  ;# LEDR14
   set_location_assignment PIN_AE13  -to dbg_actual_rd_bank  ;# LEDR15
   set_location_assignment PIN_AE12  -to dbg_wr_bank_val  ;# LEDR16
   set_location_assignment PIN_AD12  -to dbg_rd_bank_val  ;# LEDR17 on the left side
  ...
  ;# the group of 4 seven segments on the right
   ...
   set_location_assignment PIN_AF10 -to lsb_mem[6]   ;# a HEX0S[6]
   set_location_assignment PIN_AB12 -to lsb_mem[5]   ;# b HEX0S[5]
   set_location_assignment PIN_AC12 -to lsb_mem[4]   ;# c HEX0S[4]
   set_location_assignment PIN_AD11 -to lsb_mem[3]   ;# d HEX0S[3]
   set_location_assignment PIN_AE11 -to lsb_mem[2]   ;# e HEX0S[2]
   set_location_assignment PIN_V14  -to lsb_mem[1]   ;# f HEX0S[1]
   set_location_assignment PIN_V13  -to lsb_mem[0]   ;# g HEX0S[0]

   set_location_assignment PIN_V20  -to msb_mem[6]   ;# a HEX1S[6]
   set_location_assignment PIN_V21  -to msb_mem[5]   ;# b HEX1S[5]
   set_location_assignment PIN_W21  -to msb_mem[4]   ;# c HEX1S[4]
   set_location_assignment PIN_Y22  -to msb_mem[3]   ;# d HEX1S[3]
   set_location_assignment PIN_AA24 -to msb_mem[2]   ;# e HEX1S[2]
   set_location_assignment PIN_AA23 -to msb_mem[1]   ;# f HEX1S[1]
   set_location_assignment PIN_AB24 -to msb_mem[0]   ;# g HEX1S[0]

   set_location_assignment PIN_AB23 -to lsb_disp[6]   ;# a HEX2S[6]
   set_location_assignment PIN_V22  -to lsb_disp[5]   ;# b HEX2S[5]
   set_location_assignment PIN_AC25 -to lsb_disp[4]   ;# c HEX2S[4]
   set_location_assignment PIN_AC26 -to lsb_disp[3]   ;# d HEX2S[3]
   set_location_assignment PIN_AB26 -to lsb_disp[2]   ;# e HEX2S[2]
   set_location_assignment PIN_AB25 -to lsb_disp[1]   ;# f HEX2S[1]
   set_location_assignment PIN_Y24  -to lsb_disp[0]   ;# g HEX2S[0]

   set_location_assignment PIN_Y23  -to msb_disp[6]   ;# a HEX3S[6]
   set_location_assignment PIN_AA25 -to msb_disp[5]   ;# b HEX3S[5]
   set_location_assignment PIN_AA26 -to msb_disp[4]   ;# c HEX3S[4]
   set_location_assignment PIN_Y26  -to msb_disp[3]   ;# d HEX3S[3]
   set_location_assignment PIN_Y25  -to msb_disp[2]   ;# e HEX3S[2]
   set_location_assignment PIN_U22  -to msb_disp[1]   ;# f HEX3S[1]
   set_location_assignment PIN_W24  -to msb_disp[0]   ;# g HEX3S[0]

  ;# the group of 2 seven segments in the middle

   set_location_assignment PIN_U9   -to lsb_tx[6]   ;# a HEX4S[6]
   set_location_assignment PIN_U1   -to lsb_tx[5]   ;# b HEX4S[5]
   set_location_assignment PIN_U2   -to lsb_tx[4]   ;# c HEX4S[4]
   set_location_assignment PIN_T4   -to lsb_tx[3]   ;# d HEX4S[3]
   set_location_assignment PIN_R7   -to lsb_tx[2]   ;# e HEX4S[2]
   set_location_assignment PIN_R6   -to lsb_tx[1]   ;# f HEX4S[1]
   set_location_assignment PIN_T3   -to lsb_tx[0]   ;# g HEX4S[0]

   set_location_assignment PIN_T2   -to msb_tx[6]   ;# a HEX5S[6]
   set_location_assignment PIN_P6   -to msb_tx[5]   ;# b HEX5S[5]
   set_location_assignment PIN_P7   -to msb_tx[4]   ;# c HEX5S[4]
   set_location_assignment PIN_T9   -to msb_tx[3]   ;# d HEX5S[3]
   set_location_assignment PIN_R5   -to msb_tx[2]   ;# e HEX5S[2]
   set_location_assignment PIN_R4   -to msb_tx[1]   ;# f HEX5S[1]
   set_location_assignment PIN_R3   -to msb_tx[0]   ;# g HEX5S[0]

  ;# the group of 2 seven segments on the left

  set_location_assignment PIN_R2   -to lsb_version[6]   ;# a HEX6S[6]
  set_location_assignment PIN_P4   -to lsb_version[5]   ;# b HEX6S[5]
  set_location_assignment PIN_P3   -to lsb_version[4]   ;# c HEX6S[4]
  set_location_assignment PIN_M2   -to lsb_version[3]   ;# d HEX6S[3]
  set_location_assignment PIN_M3   -to lsb_version[2]   ;# e HEX6S[2]
  set_location_assignment PIN_M5   -to lsb_version[1]   ;# f HEX6S[1]
  set_location_assignment PIN_M4   -to lsb_version[0]   ;# g HEX6S[0]
                                    
  set_location_assignment PIN_L3   -to msb_version[6]   ;# a HEX7S[6]
  set_location_assignment PIN_L2   -to msb_version[5]   ;# b HEX7S[5]
  set_location_assignment PIN_L9   -to msb_version[4]   ;# c HEX7S[4]
  set_location_assignment PIN_L6   -to msb_version[3]   ;# d HEX7S[3]
  set_location_assignment PIN_L7   -to msb_version[2]   ;# e HEX7S[2]
  set_location_assignment PIN_P9   -to msb_version[1]   ;# f HEX7S[1]
  set_location_assignment PIN_N9   -to msb_version[0]   ;# g HEX7S[0]
...
#   set_location_assignment PIN_B6 -to I2C_SDAT
   ...
   set_location_assignment PIN_B8   -to clk_vesa_out
